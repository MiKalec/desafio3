...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewOrder2githubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐNewOrder)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNOrder2ᚖgithubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrder,
		true,
		true,
	)
}
...
func (ec *executionContext) _Order_orderType(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Order_orderType,
		func(ctx context.Context) (any, error) {
...
func (ec *executionContext) _Order_description(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Order_description,
		func(ctx context.Context) (any, error) {
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNOrder2ᚕᚖgithubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrderᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) unmarshalInputNewOrder(ctx context.Context, obj any) (model.NewOrder, error) {
	...
	fieldsInOrder := [...]string{"name", "orderType", "description"}
...
func (ec *executionContext) unmarshalNNewOrder2githubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐNewOrder(ctx context.Context, v any) (model.NewOrder, error) {
	res, err := ec.unmarshalInputNewOrder(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNOrder2githubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋMiKalecᚋdesafio3ᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
